...
for ip in ${RACK[@]}; do $cmd $ip "pwreg set timeshiftbufferdrivestatedbg 0"; done; check_health; sleep 15
#for ip in ${RACK[@]}; do $cmd $ip "$var pause"; done; check_health; sleep 15
#for ip in ${RACK[@]}; do $cmd $ip "$var play"; done; check_health; sleep 15
for ip in ${RACK[@]}; do $cmd $ip "pwreg set timeshiftbufferdrivestatedbg 2"; done; check_health; sleep 15
