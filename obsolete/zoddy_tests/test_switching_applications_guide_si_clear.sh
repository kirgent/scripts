...
i=1
for box in ${RACK[@]}; do $cmd $box "$var e"; done; check_health; sleep 15
while true; do
echo "iteration=$i"
for box in ${RACK[@]}; do $cmd $box "$var 2"; done; check_health; sleep 15
for box in ${RACK[@]}; do $cmd $box "si clear"; done
...
for box in ${RACK[@]}; do $cmd $box "$var rew,rew,rew,rew"; done; check_health; sleep 2
